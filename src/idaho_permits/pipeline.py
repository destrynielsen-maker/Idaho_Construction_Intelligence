...
from .collectors.caldwell import CaldwellCitizenserveDiscoveryCollector
...
COLLECTORS=[BoiseDevelopmentCollector(),EaglePermitCollector(),CanyonCountyPermitCollector(),CaldwellCitizenserveDiscoveryCollector(),CoeurDAleneCollector(),KootenaiCountyCollector(),MeridianCollector(),NampaCollector()]
