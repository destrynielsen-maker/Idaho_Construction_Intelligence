...
from .collectors.caldwell import CaldwellReportDiscoveryCollector
...
COLLECTORS=[BoiseDevelopmentCollector(),EaglePermitCollector(),CanyonCountyPermitCollector(),CaldwellReportDiscoveryCollector(),CoeurDAleneCollector(),KootenaiCountyCollector(),MeridianCollector(),NampaCollector()]
