SOURCES = [
 ...
 {'market':'Caldwell','grade':'A+ candidate','mode':'discovery-direct-pdf','url':'https://www.cityofcaldwell.org/files/assets/city/v/1/building/documents/permit-apps/july-2026-building-report.pdf','use':'Official monthly building report PDFs via predictable direct City file path; index page is runner-blocked'},
