SOURCES = [
 ...
 {'market':'Caldwell','grade':'A+ candidate','mode':'discovery-report','url':'https://www.cityofcaldwell.org/Departments/Community-Development/Building-Safety-Division/Building-Bulletins-Reports','use':'Official monthly building reports; production fallback after Citizenserve POST returned HTTP 401 on GitHub Actions'},
 {'market':'Caldwell Citizenserve','grade':'B manual-detail','mode':'rep-research','url':'https://www2.citizenserve.com/Portal/PortalController?Action=showSearchPage&ctzPagePrefix=Portal_&type=Permit&installationID=263','use':'Official public permit detail lookup; unattended search POST is not runner-accessible'},
