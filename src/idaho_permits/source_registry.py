SOURCES = [
 ...
 {'market':'Canyon County','grade':'A+','mode':'automated-gis','url':'https://maps.canyonco.org/arcgisserver/rest/services/DSD/DSD_BLDG_PERMITS/FeatureServer/0','use':'Official issued building permits with permit number, issue date, project, contractor, valuation and status'},
